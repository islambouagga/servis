...
class GGTravelController extends \App\Http\Controllers\Controller
{
    ...
    public function hotelSearchRequest()
    {
        ...
        $this->ggtRequest->hotelSearchMain(1, 0, 1000, 20, 500, 'HB', 'GB', 1133, 33818, '2020-11-05', 3, 7, 'true');
    ...
    public function hotelInfoRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->hotelInfoMain(33818);
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function bookingInsertRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->bookingInsertMain("Test AgRef", "11275046/4425764357706917095/5582", "2020-10-05", 3, "1");
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function bookingStatusRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->bookingStatusMain(18437681);
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function bookingSearchRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->bookingSearchMain(18437681);
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function advBookingSearchRequest()
    {
        ...
        $this->ggtRequest->advBookingSearchMain("2020-10-01", "2020-10-30", "JOHN DOE", 1133, 3, "CLEVELAND");
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function bookingCancelRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->bookingCancelMain(18437681);
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function bookingValuationRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->bookingValuationMain("11363301/3527577741245198494/608", "2012-11-05");
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
    ...
    public function voucherDetailsRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->voucherDetailsMain("18437811", "true");
    ...
    public function priceBreakdownRequest()
    {
        ...
        $requestType = $this->ggtRequest->getRequestType();
        $header = $this->ggtRequest->setHeader();
        $this->ggtRequest->priceBreakdownMain("11275046/700105648464590535/4421");
        $main = $this->ggtRequest->getMain();
        $xmlRequest = "<Root>" . $header . $main . "</Root>";
        $this->callServise(new MakeRequest($requestType, $xmlRequest));
    }
